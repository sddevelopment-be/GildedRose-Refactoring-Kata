...
public class EventTicketsBusinessTest {
  ...
  void givenTicketsToAnEvent_whenTheEventIsLessThanTenDaysAway_TheQualityIncreasesByTwo() {
    GildedRose theGildedRose = InnTestUtilities.createInnWithSingleItem(new Item("Backstage passes to a TAFKAL80ETC concert", 15, 20));
  ...
  void givenTicketsToAnEvent_whenTheEventIsLessThanThreeDaysAway_TheQualityIncreasesByThree() {
    GildedRose theGildedRose = InnTestUtilities.createInnWithSingleItem(new Item("Backstage passes to a TAFKAL80ETC concert", 3, 20));
